...
class SatuPoinAssist extends StatefulWidget {
  const SatuPoinAssist({Key? key}) : super(key: key);

  @override
  State<SatuPoinAssist> createState() => _SatuPoinState();
}

class _SatuPoinState extends State<SatuPoinAssist> {
