...
class Fouls extends StatefulWidget {
  const Fouls({Key? key}) : super(key: key);

  @override
  State<Fouls> createState() => _FoulsState();
}

class _FoulsState extends State<Fouls> {
  List<String> data = [
    'Offensive Foul',
    'Foul Out',
    'Technical Foul',
